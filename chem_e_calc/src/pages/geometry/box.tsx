  ...
  const [values, setValues] = useState<InputType[]>([
    {
      ...
      label: 'Width',
      displayValue: { value: 1, unit: defaultUnits.length.value },
      calculatedValue: {
        value: convertUnits({ value: 1, fromUnit: defaultUnits.length.value, toUnit: 'm' }),
        unit: 'm',
      },
      solveable: true,
    ...
    },
    {
      ...
      placeholder: 'enter value',
      label: 'Volume',
      displayValue: { value: '', unit: defaultUnits.volume.value },
      calculatedValue: {
        value: convertUnits({ value: 1, fromUnit: defaultUnits.volume.value, toUnit: 'm3' }),
        unit: 'm3',
      },
      solveable: true,
